...
class MSExMenu_Template_Block_Navigation extends Mage_Catalog_Block_Navigation
{
    const CUSTOM_BLOCK_TEMPLATE = 'wp_custom_menu_%d';


    public function drawCustomMenuItem($category, $i, $level = 0, $last = false)
    {
        ...
        if ($drawPopup)
        {
            $html[] = '<div id="menu' . $id . '" class="menu popup-menu level-'.$i.'' . $active . '" onmouseover="wpShowMenuPopup(this, \'popup' . $id . '\');" onmouseout="wpHideMenuPopup(this, event, \'popup' . $id . '\', \'menu' . $id . '\')">';
        }
        else
        {
            $html[] = '<div id="menu' . $id . '" class="menu level-'.$i.'">';
        }
        // --- Top Menu Item ---		
        ...
        if ($drawPopup)
        {
            ...
            $html[] = '<div id="popup' . $id . '" class="popup child-'.$i.'" onmouseout="wpHideMenuPopup(this, event, \'popup' . $id . '\', \'menu' . $id . '\')">';
            // --- draw Sub Categories ---
